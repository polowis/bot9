...
module.exports = async function trainnlp(manager, say) {
  ...
  const fromEntity = manager.addTrimEntity('toKick')
  fromEntity.addAfterLastCondition()
  ...
  manager.addDocument('en', 'I need to see my information', 'commands.userinfo')
  manager.addDocument('en', 'View my information', 'commands.userinfo')
  manager.addDocument('en', "Who am I", 'commands.userinfo')

  manager.addDocument('en', 'Show me my money', 'commands.pocket');
  manager.addDocument('en', 'How much money do I have', 'commands.pocket')
  manager.addDocument('en', 'I need to see my pocket', 'commands.pocket')
  manager.addDocument('en', 'Can you show me how much I have', 'commands.pocket')
  manager.addDocument('en', 'Check my balance', 'commands.pocket')
  manager.addDocument('en', 'Show me my balance', 'commands.pocket')
  manager.addDocument('en', 'Show me danbooru content', 'commands.danbooru')
  manager.addDocument('en', 'Get a random image from danbooru', 'commands.danbooru')
  manager.addDocument('en', 'Hentai image', 'commands.danbooru')
  manager.addDocument('en', 'Display some danbooru images for me', 'commands.danbooru')
  manager.addDocument('en', 'Crawling danbooru for me', 'commands.danbooru')
  manager.addDocument('en', 'Danbooru requesting', 'commands.danbooru')
  manager.addDocument('en', 'Show me some rem image', 'commands.rem')
  manager.addDocument('en', 'Rem image request', 'commands.rem')
  manager.addDocument('en', 'Show me a picture of rem', 'commands.rem')
  manager.addDocument('en', 'Rem character', 'commands.rem')
  ...
  manager.addAnswer('en', 'commands.rem', 'I like rem too')
  manager.addAnswer('en', 'commands.rem', 'Will you marry her?')
  manager.addAnswer('en', 'commands.rem', 'I hate Emilia')
  manager.addAnswer('en', 'commands.rem', 'Let see what we got!')
  manager.addAnswer('en', 'commands.danbooru', 'Ouch, are you over 19 yet?')
  manager.addAnswer('en', 'commands.danbooru', 'I am going to tell your parents')
  manager.addAnswer('en', 'commands.danbooru', 'Hey, check your age, I have warned you')
  manager.addAnswer('en', 'commands.danbooru', 'Shhh, someone is calling the police...')
  manager.addAnswer('en', 'commands.pocket', 'Here you go')
  manager.addAnswer('en', 'commands.pocket', 'There you go')
  manager.addAnswer('en', 'commands.pocket', 'here you go')
  manager.addAnswer('en', 'commands.userinfo', 'You are...')
  manager.addAnswer('en', 'commands.userinfo', 'Can I change your profile?')
  manager.addAnswer('en', 'commands.userinfo', 'Let me do something with your photo!. uhm.. maybe add a little more color')
  ...
  manager.addAnswer('en', 'agent.bad', "I'll tell my developer to look into this")
  manager.addAnswer('en', 'agent.bad', "I'm still learning..")
  manager.addAnswer(
    'en',
    'agent.bad',
  ...
  manager.addAnswer('en', 'agent.boss', 'Hung Tran is the one who developed me');
  manager.addAnswer('en', 'agent.boss', 'I was made with love by Polowis!')
  manager.addAnswer(
    'en',
    'agent.busy',
